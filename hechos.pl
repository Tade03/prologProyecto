...
subtipo_etnicidad(nahuatl, indigenas).
...
subtipo_etnicidad(totonaca, indigenas).
...
% Etapas de Vida
etapas_de_vida(infancia).
etapas_de_vida(ninez).
...
etapa_edad(infancia, 4).
etapa_edad(infancia, 5).
etapa_edad(ninez, 6).
etapa_edad(ninez, 7).
etapa_edad(ninez, 8).
etapa_edad(ninez, 9).
etapa_edad(ninez, 10).
etapa_edad(ninez, 11).
etapa_edad(adolescencia, 12).
etapa_edad(adolescencia, 13).
etapa_edad(adolescencia, 14).
etapa_edad(adolescencia, 15).
etapa_edad(adolescencia, 16).
etapa_edad(adolescencia, 17).
etapa_edad(adolescencia, 18).
etapa_edad(adolescencia, 19).
etapa_edad(juventud, 14).
etapa_edad(juventud, 15).
etapa_edad(juventud, 16).
etapa_edad(juventud, 17).
etapa_edad(juventud, 18).
etapa_edad(juventud, 19).
etapa_edad(juventud, 20).
etapa_edad(juventud, 21).
etapa_edad(juventud, 22).
etapa_edad(juventud, 23).
etapa_edad(juventud, 24).
etapa_edad(juventud, 25).
etapa_edad(juventud, 26).
etapa_edad(adultez, 27).
etapa_edad(adultez, 28).
etapa_edad(adultez, 29).
etapa_edad(adultez, 30).
etapa_edad(adultez, 31).
etapa_edad(adultez, 32).
etapa_edad(adultez, 33).
etapa_edad(adultez, 34).
etapa_edad(adultez, 35).
etapa_edad(adultez, 36).
etapa_edad(adultez, 37).
etapa_edad(adultez, 38).
etapa_edad(adultez, 39).
etapa_edad(adultez, 40).
etapa_edad(adultez, 41).
etapa_edad(adultez, 42).
etapa_edad(adultez, 43).
etapa_edad(adultez, 44).
etapa_edad(adultez, 45).
etapa_edad(adultez, 46).
etapa_edad(adultez, 47).
etapa_edad(adultez, 48).
etapa_edad(adultez, 49).
etapa_edad(adultez, 50).
etapa_edad(adultez, 51).
etapa_edad(adultez, 52).
etapa_edad(adultez, 53).
etapa_edad(adultez, 54).
etapa_edad(adultez, 55).
etapa_edad(adultez, 56).
etapa_edad(adultez, 57).
etapa_edad(adultez, 58).
etapa_edad(adultez, 59).
etapa_edad(adulto_mayor, 60).
etapa_edad(adulto_mayor, 61).
etapa_edad(adulto_mayor, 62).
etapa_edad(adulto_mayor, 63).
etapa_edad(adulto_mayor, 64).
etapa_edad(adulto_mayor, 65).
etapa_edad(adulto_mayor, 66).
etapa_edad(adulto_mayor, 67).
etapa_edad(adulto_mayor, 68).
etapa_edad(adulto_mayor, 69).
etapa_edad(adulto_mayor, 70).
etapa_edad(adulto_mayor, 71).
etapa_edad(adulto_mayor, 72).
etapa_edad(adulto_mayor, 73).
etapa_edad(adulto_mayor, 74).
etapa_edad(adulto_mayor, 75).
etapa_edad(adulto_mayor, 76).
etapa_edad(adulto_mayor, 77).
etapa_edad(adulto_mayor, 78).
etapa_edad(adulto_mayor, 79).
etapa_edad(adulto_mayor, 80).
etapa_edad(adulto_mayor, 81).
etapa_edad(adulto_mayor, 82).
etapa_edad(adulto_mayor, 83).
etapa_edad(adulto_mayor, 84).
etapa_edad(adulto_mayor, 85).
etapa_edad(adulto_mayor, 86).
etapa_edad(adulto_mayor, 87).
etapa_edad(adulto_mayor, 88).
etapa_edad(adulto_mayor, 89).
etapa_edad(adulto_mayor, 90).
etapa_edad(adulto_mayor, 91).
etapa_edad(adulto_mayor, 92).
etapa_edad(adulto_mayor, 93).
etapa_edad(adulto_mayor, 94).
etapa_edad(adulto_mayor, 95).
etapa_edad(adulto_mayor, 96).
etapa_edad(adulto_mayor, 97).
etapa_edad(adulto_mayor, 98).
etapa_edad(adulto_mayor, 99).
etapa_edad(adulto_mayor, 100).
etapa_edad(adulto_mayor, 101).
etapa_edad(adulto_mayor, 102).
etapa_edad(adulto_mayor, 103).
etapa_edad(adulto_mayor, 104).
etapa_edad(adulto_mayor, 105).
etapa_edad(adulto_mayor, 106).
etapa_edad(adulto_mayor, 107).
etapa_edad(adulto_mayor, 108).
etapa_edad(adulto_mayor, 109).
etapa_edad(adulto_mayor, 110).
etapa_edad(adulto_mayor, 111).
etapa_edad(adulto_mayor, 112).
etapa_edad(adulto_mayor, 113).
etapa_edad(adulto_mayor, 114).
etapa_edad(adulto_mayor, 115).
etapa_edad(adulto_mayor, 116).
...
situacion_economica(clase_media_baja).
situacion_economica(clase_media).
...
% Religión
religion(catolicos).
religion(protestantes_evangelicos).
religion(testigos_de_jehova).
religion(mormones).
religion(judios).
religion(musulmanes).
religion(budistas).
religion(hinduistas).
religion(sin_religion).

% Idioma
idioma(hablantes_de_espanol).
idioma(hablantes_de_lenguas_indigenas).
idioma(hablantes_de_lenguas_extranjeras).

% Subcategoria de Idioma

subtipo_idioma(nahuatl, hablantes_de_lenguas_indigenas).
subtipo_idioma(maya, hablantes_de_lenguas_indigenas).
subtipo_idioma(zapoteco, hablantes_de_lenguas_indigenas).
subtipo_idioma(ingles, hablantes_de_lenguas_extranjeras).
subtipo_idioma(aleman, hablantes_de_lenguas_extranjeras).
subtipo_idioma(frances, hablantes_de_lenguas_extranjeras).

% Ocupación
ocupacion(campesinos).
ocupacion(pescadores).
ocupacion(mineros).
ocupacion(obrero_industriales).
ocupacion(comerciantes).
ocupacion(profesionales).
ocupacion(funcionarios_publicos).
ocupacion(artistas_y_artesanos).
ocupacion(trabajadores_del_sector_servicios).
ocupacion(emprendedores).

% Estado Civil
estado_civil(solteros).
estado_civil(casados).
estado_civil(divorciados).
estado_civil(viudos).
...
% Residencia
residencia(urbanos).
residencia(suburbanos).
residencia(rurales).
residencia(migrantes).
...
condicion_de_salud(personas_sin_discapacidad).
condicion_de_salud(personas_con_enfermedades_cronicas).
condicion_de_salud(personas_con_enfermedades_mentales).

% Preferencia Alimentaria
preferencia_alimentaria(omnivoros).
preferencia_alimentaria(vegetarianos).
preferencia_alimentaria(veganos).
...
situacion_religion(clase_media, catolicos).
situacion_religion(clase_media_alta, judios).
situacion_religion(clase_alta, protestantes_evangelicos).
situacion_religion(clase_media_baja, testigos_de_jehova).
situacion_religion(clase_media, mormones).

% Relación entre Situación Económica y Idioma
situacion_idioma(clase_media, hablantes_de_espanol).
situacion_idioma(clase_media_alta, hablantes_de_lenguas_extranjeras).
situacion_idioma(clase_baja, hablantes_de_lenguas_indigenas).
situacion_idioma(clase_alta, hablantes_de_lenguas_extranjeras).

% Relación entre Religión y Idioma
religion_idioma(catolicos, hablantes_de_espanol).
religion_idioma(judios, hablantes_de_lenguas_extranjeras).
religion_idioma(musulmanes, hablantes_de_lenguas_extranjeras).
religion_idioma(budistas, hablantes_de_lenguas_extranjeras).
religion_idioma(hinduistas, hablantes_de_lenguas_extranjeras).

% Relación entre Subtipo de Idioma y Situación Económica
subtipo_situacion(nahuatl, clase_baja).
subtipo_situacion(maya, clase_baja).
...
subtipo_religion(ingles, protestantes_evangelicos).
